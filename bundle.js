...
/*-----------------------------------------------------------------------------
  LOADING DATA
-----------------------------------------------------------------------------*/
minixhr('https://api.github.com/users/zgubidanac', responseHandler1)
...
function footerComponent ({ data = {}, theme = {} } = {}) {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/zgubidanac">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
        <a href="mailto:djukanovicnemanj@gmail.com ">
        <i class="${css.icon} fa fa-envelope-o" aria-hidden="true"></i>
      </a>
      <a href="https://www.facebook.com/nemanja.djukanovic1/">
...
},{"csjs-inject":6,"minixhr":25,"yo-yo":29}],3:[function(require,module,exports){
...
},{"global/document":20,"hyperx":23,"on-load":27}],4:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./update-events.js":30,"bel":3,"morphdom":26}],30:[function(require,module,exports){
module.exports = [
